...
INSERT INTO `pss_countries` (`id`, `country_code`, `name`, `phone_code`) VALUES
(1, 'AF', 'Afghanistan', 93),
(2, 'AL', 'Albania', 355),
(3, 'DZ', 'Algeria', 213),
...
INSERT INTO `timesheet`.`pss_locations`
(`created_by`,
`updated_by`,
`location`)
VALUES
("System","System","India(Hyderabad)");
